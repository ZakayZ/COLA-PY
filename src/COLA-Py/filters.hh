...
namespace cola::python {
    class PythonConverter : public VConverter, private PythonFilterBase {
      public:
        PythonConverter(const std::string& importPath, const std::unordered_map<std::string, std::string>& metaData);
    ...
    class PythonGenerator : public VGenerator, private PythonFilterBase {
      public:
        PythonGenerator(const std::string& importPath, const std::unordered_map<std::string, std::string>& metaData);
    ...
    class PythonWriter : public VWriter, private PythonFilterBase {
      public:
        PythonWriter(const std::string& importPath, const std::unordered_map<std::string, std::string>& metaData);
