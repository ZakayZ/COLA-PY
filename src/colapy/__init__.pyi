...
class RunManager:
    ...
    def load_module(self, library_path: str, library_prefix: str = ...) -> RunManager: ...

    def load_config(self, *, file: str | Path = None, config: str =) -> RunManager: ...

    def load_config_xml(self, config_xml: str) -> RunManager: ...

    def load_config_file(self, config_path: str) -> RunManager: ...
